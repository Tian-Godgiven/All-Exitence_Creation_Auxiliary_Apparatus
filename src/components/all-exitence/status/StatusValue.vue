...
<div class="value" :class="disabled?'disabled':''">
	<component :status :fullStatus :target :is="statusValueVueList[valueType]"></component>
</div>
</template>
